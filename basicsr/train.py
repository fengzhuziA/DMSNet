...
#python -m torch.distributed.launch --nproc_per_node=4 --master_port=4321 basicsr/train.py -opt options/train/GoPro/NAFNet-width32.yml --launcher pytorch
# ------------------------------------------------------------------------
import argparse
import datetime
import logging
...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str,default='options/train/GoPro/DMSNetHTB-width32.yml',  help='Path to option YAML file.')
    parser.add_argument(
        '--launcher',
